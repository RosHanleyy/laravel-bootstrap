...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <body class="antialiased bg-secondary text-white">
            @extends('layouts.app')

            @section('content')
            <div class="container px-0 mx-10 bg-danger">
                <div class="row">
                    <div>
                        ...
                        <div class="row row-cols-1 mt-5">
                            <div class="col">
                                <div class="h2 text-center fw-bold d-flex justify-content-center">
                                    Types of repairs
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row-cols-2 row-cols-md-5 g-4 mt-2 mx-3">
                            <div class="col m-0">
                                <div class="py-2 mx-4">
                                    <div class="card w-75 border-0 rounded-0">
                                                            <div class="card-body bg-primary d-flex justify-content-center p-0">
                                            <a href="#" class="btn btn-primary m-0 py-2 px-0 rounded-0">Test link</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row row-cols-1 row-cols-md-2 g-4 mt-5 mx-3">
                            <div class="col">
                                <div class="bg-light py-2 mx-4">
                                    <div class="h4 fw-bold d-flex justify-content-center">
                                        Repair tools
                                    </div>
                                    <div class="h5 d-flex text-center justify content-center pt-2 mx-3">
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi et aliquet
                                        libero. Aliquam faucibus, quam sed viverra elementum, ipsum dolor imperdiet
                                        mauris.
                                    </div>
                                </div>
                            </div>
